...
<section class="body-sign">
    <div class="center-sign">
        <div class="tkbn">
            <a href="http://titangelchinhhang.net/" class="">
        ...
        <div class="">
            <div class="panel-body" style="text-align:center">
                <p class="tkf">Cảm ơn bạn đã đặt hàng.</p>
                <p class="tkdes">Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất.</p>
                ...
                <div class="row">
                    <div class="col-sm-12 btn-end">
                        <a href="http://titangelchinhhang.net/" class="btn-lg-x">Trở về trang chủ</a>
                    </div>
                </div>
            </div>
